...
WebUI.click(findTestObject('Object Repository/Page_Create Next App/td_MENU_px-6 w-20px h-56px'))

WebUI.rightClick(findTestObject('Object Repository/Page_Create Next App/td_SubRiceCool'))

WebUI.rightClick(findTestObject('Object Repository/Page_Create Next App/input_Add Category_input-group-1'))
