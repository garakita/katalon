...
WebUI.click(findTestObject('Object Repository/Page_Sign In/div_Username'))
...
WebUI.click(findTestObject('Object Repository/Page_Create Next App/button_Add Category'))

WebUI.click(findTestObject('Object Repository/Page_Create Next App/button_Confirm'))

WebUI.click(findTestObject('Object Repository/Page_Create Next App/svg_Add SubCategory_absolute top-12 transfo_2e79f2'))

WebUI.click(findTestObject('Object Repository/Page_Create Next App/button_Crop Done'))
